...
@Slf4j
//TODO boothController /api 접두사 삭제
public class AnnouncementController {
    private final AnnouncementService announcementService;

    @Operation(summary = "관심 축제 등록")
    @PostMapping("/festival/{festival-id}/interest")
    ...
    @DeleteMapping("/festival/{festival-id}/interest")
    ...
    @PostMapping("/booth/{booth-id}/announcement")
