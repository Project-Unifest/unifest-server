...
public interface FestivalRepository extends JpaRepository<Festival, Long> {
    ...
    //학교
    @Query("select new UniFest.dto.response.festival.FestivalSearchResponse(f.id, s.id, s.thumbnail, s.name, f.name, f.beginDate, f.endDate, s.latitude, s.longitude)"
